...
import 'package:food_dilivery_application_1/pages/Admipanel.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  userLogin() async {
    try {
      ...
      if (email == "sureshgayan2001@gmail.com" && password == "Lion@123") {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
              builder: (context) => AdminBottomNav()), // Navigate to admin page
        );
      } else {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
              builder: (context) =>
                  BottomNav()), // Navigate to regular user page
        );
      }
